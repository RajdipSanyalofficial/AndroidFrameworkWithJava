package com.example.controllingcamerademo;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String TAG = "ControllingCameraDemo";
    ...
    // Listener for TextureView to set up camera preview
    TextureView.SurfaceTextureListener textureListener = new TextureView.SurfaceTextureListener() {
        @Override
        public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
            // Open the camera when the texture is available
            openCamera();
        }
        ...
        public void onSurfaceTextureUpdated(SurfaceTexture surface) {
            // Called whenever there's an update to the texture (i.e., each frame)
        }
    };
    ...
    private final ImageReader.OnImageAvailableListener readerListener = new ImageReader.OnImageAvailableListener() {
        ...
        private void save(byte[] bytes) {
            try (FileOutputStream output = new FileOutputStream(file)) {
                output.write(bytes);
                // Use ExifInterface to read/write EXIF data
                ExifInterface exif = new ExifInterface(file.getAbsolutePath());
                exif.setAttribute(ExifInterface.TAG_MAKE, "My Camera");
                exif.saveAttributes();
            } catch (IOException e) {
                e.printStackTrace();
            }
